...
/*
 * Hàm Nhap: Nhập ngày, tháng, năm cho một ngày.
...
/*
 * Hàm namNhuan: Kiểm tra xem một năm có phải là năm nhuận không.
 * Đầu vào: Một số nguyên nam (năm cần kiểm tra).
...
/*
 * Hàm soNgayTrongThang: Tính số ngày trong một tháng của một năm cụ thể.
 * Đầu vào: Số nguyên thang (tháng) và nam (năm).
 * Đầu ra: Trả về số ngày trong tháng đó.
 */
