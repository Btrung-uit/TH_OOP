 ...
 * Đầu vào: Tham chiếu đến một biến PhanSo p (được truyền bằng tham chiếu để thay đổi giá trị).
 * Đầu ra: Không trả về giá trị, nhưng thay đổi giá trị của p để rút gọn.
 */
...
/*
 * Hàm Xuat: Xuất phân số ra màn hình sau khi đã rút gọn.
 * Đầu vào: Một biến PhanSo p (được truyền bằng giá trị).
...
/*
 * Hàm main: Hàm chính của chương trình, thực hiện nhập, rút gọn và xuất hai phân số.
